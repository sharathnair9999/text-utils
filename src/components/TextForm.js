...
export default function TextForm(props) {
  ...
  const copyText = (text)=>{      
      navigator.clipboard.writeText(text).then(function() {
        props.showAlert('Copying to clipboard was successful!','success');
      });
    ...
    <>
      <div className="container">
        ...
        <div className="mb-3">
          <textarea
            ...
            style={{
              backgroundColor: props.mode === "light" ? "white" : "#051d41",
      ...
      <div className="container my-3">
        ...
        <p>
          ...
          and {text.split("").length} characters
        </p>
        <p>
          {" "}
          This passage will take{" "}
          {text.trim().length === 0
            ? "0"
            : text.trim().split(" ").length * 0.008}{" "}
          minutes of read.
        </p>
        <h2>Preview</h2>
        <p>
